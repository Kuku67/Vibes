(function($) {
    ...
    $(document).ready(function() {
        $('.accordion-item').simpleAccordion();
    });
    ...
    $.fn.simpleAccordion = function(options) {
        ...
        var opts = $.extend({
            item: '.accordion-ui-title', // Wrapper of trigger + content
            trigger: '.accordion-ui-trigger', // Item's trigger
            content: '.accordion-ui-content', // Content to show/hide
            active: 'active', // Active class (= opened item)
            autoclose: true, // Close opened items when clicking anywhere on docment (but on the accordion)
